...
def signup():
    if request.method == 'POST':
        ...
        if user:
            ...
            flash('Email must be greater than 4 four characters', category='error')
            ...
            new_user = User(email = email, firstname = firstname, givenname = givenname, password = generate_password_hash(password1 , method='sha256'))
